...
<body>
   <div class="sidebar">
    <div class="logo-details">
      ...
      <span class="logo_name">Ayushi</span>
    </div>
      <ul class="nav-links">
        <li>
          <a href="home.php" >
        ...
        <li>
          <a href="manage-expenses.php" class="active">
       ...
       <li>
          <a href="analytics.php">
            ...
            <span class="links_name">Analytics Chart</span>
          </a>
        </li>
        <li>
          <a href="report.php">
  ...
  <section class="home-section">
    ...
    <div class="sidebar-button">
        ...
        <span class="dashboard">Expance Tracker</span>
      </div>
